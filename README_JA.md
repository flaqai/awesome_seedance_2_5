...
## Flaq AI Affiliate Programでコミッションを得る

開発者、AIエージェント開発者、モデルレビュアー、クリエイティブチーム、AI教育者は、[Flaq AI Affiliate Program](https://flaq.ai/affiliate-program/)に登録して紹介リンクを作成できます。現在の公開条件では、紹介ユーザーの**最初の有効な有料注文は20%**、登録後60日以内の**以降の有効な有料注文は10%**です。

返金、帰属、審査、ポリシーにより対象や支払いが変わる場合があります。リンク共有時はアフィリエイト関係を明示し、最新規約を確認してください。[15言語ガイド](docs/flaq-affiliate-program.md)も参照できます。
